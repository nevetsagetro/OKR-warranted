...
Source: https://www.twilio.com/en-us/guidelines/nf/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | NF |
| Region | --- | Oceania |
...
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +672 |
...
| Service restrictions | Before you start sending messages towards Norfolk Island, contact your dedicated account manager or [Support](mailto:support@infobip.com) because of specific regulations. |
