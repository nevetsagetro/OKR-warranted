...
Source: https://www.twilio.com/en-us/guidelines/tg/sms
...
| --- | --- | --- |
| Locale name | --- | Togo |
| ISO code | The International Organization for Standardization two character representation for the given locale. | TG |
| Region | --- | Middle East & Africa |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 615 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +228 |
...
| Service restrictions | No specific restriction apply to sending traffic to Togo. |
