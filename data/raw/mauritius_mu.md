...
Source: https://www.twilio.com/en-us/guidelines/mu/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | MU |
| Region | --- | Middle East & Africa |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 617 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +230 |
...
- Mauritius Phone Number: Yes
- Mauritius Short Code: Yes
...
| Service restrictions | In Mauritius, there's traffic is differentiated by origin. Businesses must register and provide proper documentation before they can start sending local traffic. Before you start sending any traffic toward Mauritius, contact your account manager or [Support](mailto:support@infobip.com). |
...
| Sender availability | Local traffic registration is required, numbers are not allowed. Proof of brand ownership or delegation letter is required. |
