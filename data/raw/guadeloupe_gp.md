...
Source: https://www.twilio.com/en-us/guidelines/gp/sms

## Locale Summary

| Field | Description | Value |
| --- | --- | --- |
| Locale name | --- | Guadeloupe |
| ISO code | The International Organization for Standardization two character representation for the given locale. | GP |
| Region | --- | South America |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 340 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +590 |
...
| Use case restrictions | --- | --- | The character € is not supported unless the encoding UCS2 is utilised |
| Best practices | --- | --- | --- |
...
| Use case restrictions | --- | N/A | The character € is not supported unless the encoding UCS2 is utilised | --- |
| Best practices | --- | N/A | You may use a global SMS-capable number to reach mobile phones in Guadeloupe. However, the number will be overwritten with either a short code or a generic Alphanumeric Sender ID. | --- |
...
- Guadeloupe Phone Number: No
- Guadeloupe Short Code: No
