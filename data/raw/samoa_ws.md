...
Source: https://www.twilio.com/en-us/guidelines/ws/sms
...
| --- | --- | --- |
| Locale name | --- | Samoa |
| ISO code | The International Organization for Standardization two character representation for the given locale. | WS |
| Region | --- | Oceania |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 549 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +685 |
...
- Samoa Phone Number: Yes
- Samoa Short Code: Yes
