...
Source: https://www.twilio.com/en-us/guidelines/ao/sms
...
| --- | --- | --- |
| Locale name | --- | Angola |
| ISO code | The International Organization for Standardization two character representation for the given locale. | AO |
| Region | --- | Middle East & Africa |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 631 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +244 |
...
- Angola Phone Number: Yes
- Angola Short Code: Yes
...
| Service restrictions | No specific restrictions apply to sending traffic to Angola. |
...
| Sender availability | Dynamic Alpha sender allowed. Numeric senders will be manipulated into generic sender "Info". |
