...
Source: https://www.twilio.com/en-us/guidelines/pw/sms
...
| --- | --- | --- |
| Locale name | --- | Palau |
| ISO code | The International Organization for Standardization two character representation for the given locale. | PW |
| Region | --- | Oceania |
...
- Palau Phone Number: Yes
- Palau Short Code: Yes
...
| Service restrictions | Before you start sending messages towards Palau, contact your dedicated account manager or [Support](mailto:support@infobip.com) because of specific regulations. |
| Service provisioning | Between 1 and 3 days for default setup. |
