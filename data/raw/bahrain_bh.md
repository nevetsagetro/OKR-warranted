...
Source: https://www.twilio.com/en-us/guidelines/bh/sms
...
| --- | --- | --- |
| Locale name | --- | Bahrain |
| ISO code | The International Organization for Standardization two character representation for the given locale. | BH |
| Region | --- | Middle East & Africa |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 426 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +973 |
...
- Bahrain Phone Number: Yes
- Bahrain Short Code: Yes
...
| Service restrictions | No special restrictions to note. Sender registration is not needed. Any type of sender is allowed. |
| Service provisioning | Immediately available after account and route configuration. |
| Sender availability | Alpha and numeric senders supported. Full dynamic connections. |
| Sender provisioning | / |
| Two-way | Virtual Long Number. |
| Two-way provisioning | It takes up to a month. |
| Country regulations | No specific regulations. |
| Country restrictions | Gambling, betting as well as political, religious, and adult content is likely to be blocked by the Bahrain operators. |
