...
Source: https://www.twilio.com/en-us/guidelines/py/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | PY |
| Region | --- | South America |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 744 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +595 |
...
| Use case restrictions | --- | N/A | Sender ID will be overwritten with random shortcodes or local long codes outside the Twilio platform | N/A |
...
- Paraguay Phone Number: Yes
- Paraguay Short Code: Yes
...
| Sender provisioning | Shared Short Code is available immediately, dedicated Short Code can take up to 2 months to provision. |
| Two-way | - Shared Short Codes with keyword registration, if needed. - Dedicated Short Codes. |
| Two-way provisioning | Shared - 1 to 2 days. Request the configuration from your dedicated account manager or [Support](mailto:support@infobip.com). Dedicated - up to 2 months. |
| Country regulations | DND enabled. Blocklisted keywords "SALIR" over MO. ASTW: MON - FRI: 8 AM - 6 PM, SAT: 9 AM - 3 PM, SUN: Never; Timezone |
| Country restrictions | Gambling, adult, political traffic is not allowed. |
