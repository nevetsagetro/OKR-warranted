...
Source: https://www.twilio.com/en-us/guidelines/es/sms
...
| --- | --- | --- |
| Locale name | --- | Spain |
| ISO code | The International Organization for Standardization two character representation for the given locale. | ES |
| Region | --- | Europe |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 214 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +34 |
...
| Provisioning time | Provisioning is the process of getting the sender ID approved and registered with mobile networks (depending on country requirements). Provisioning time is how long this process takes in the given country. | N/A | N/A | 12-14 weeks |
| UCS-2 support | --- | Supported | Supported | Supported |
| Use case restrictions | --- | Domestic longcodes can only be used to send domestic messages | N/A | Refer to our FAQs for short code best practices |
...
- Spain Phone Number: Yes
- Spain Short Code: Yes
...
Additional Notes : You can choose between an Alpha Sender, Short Code, or Long Code number for one-way traffic
...
| Service restrictions | No specific service restrictions for sending traffic towards Spain. |
...
| Sender availability | Dynamic alpha, Short Codes, Long Numeric. Generic senders are allowed. |
| Sender provisioning | No sender registration needed. |
| Two-way | Virtual Long Number |
| Two-way provisioning | Up to 7 days. |
| Country regulations | No specific country regulations. |
| Country restrictions | Premium Short Code restriction. Only Short Codes using the following format are allowed: 205XXX, 215XXX, 207XXX, 217XXX. For other formats, Infobip cannot guarantee delivery. |
