...
Source: https://www.twilio.com/en-us/guidelines/cf/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | CF |
| Region | --- | Middle East & Africa |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 623 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +236 |
...
| --- | --- | --- | --- |
| Operator network capability | Whether mobile operators in the given country support the feature. | Not Required | Suppported |
| Twilio supported | Whether Twilio supports the feature for the given country. | --- | Suppported |
...
- Central African Republic Phone Number: Yes
- Central African Republic Short Code: Yes
...
| Service restrictions | No specific restriction apply to sending traffic to the Central African Republic. |
