...
Source: https://www.twilio.com/en-us/guidelines/pg/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | PG |
| Region | --- | Oceania |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 537 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +675 |
...
| Use case restrictions | --- | N/A | International long codes are not supported in Papua New Guinea. However Twilio will accept traffic over international long codes and will attempt to deliver it on best effort basis. | --- |
| Best practices | --- | N/A | International long codes in Papua New Guinea are not supported, please use Alpha sender for optimal results. | --- |
...
- Papua New Guinea Phone Number: Yes
- Papua New Guinea Short Code: Yes
...
| Service restrictions | Before you start sending messages towards PNG, contact your dedicated account manager or [Support](mailto:support@infobip.com) to set up this specific route for you. |
| Service provisioning | Between 1 and 3 days to configure the default setup. |
| Sender availability | Dynamic sender. Any sender is allowed. |
