...
Source: https://www.twilio.com/en-us/guidelines/bb/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | BB |
| Region | --- | North America |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 342 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +1246 |
...
- Barbados Phone Number: Yes
- Barbados Short Code: Yes
...
Additional Notes : Two-way SMS not available; dynamic sender IDs supported
...
| Service provisioning | Dynamic sender |
| Sender availability | Available immediately after the account is set up. |
| Sender provisioning | No two-way SMS options currently available. |
