...
Source: https://www.twilio.com/en-us/guidelines/jm/sms
...
| --- | --- | --- |
| Locale name | --- | Jamaica |
| ISO code | The International Organization for Standardization two character representation for the given locale. | JM |
| Region | --- | North America |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 338 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +1876 |
...
- Jamaica Phone Number: Yes
- Jamaica Short Code: Yes
...
| Two-way | Available set up: dedicated Virtual Long Number |
| Two-way provisioning | Two-way provisioning can take up to 2 months. |
