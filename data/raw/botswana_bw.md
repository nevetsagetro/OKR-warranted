...
Source: https://www.twilio.com/en-us/guidelines/bw/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | BW |
| Region | --- | Middle East & Africa |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 652 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +267 |
...
| Use case restrictions | --- | N/A | Numeric Sender ID in Botswana is not supported from the operators. Messages submitted with Numeric Sender ID will be delivered on a best effort basis and the Sender ID will be replaced by a Generic Alpha Sender ID or a Shortcode outside Twilio's Platfrom. | N/A |
| Best practices | --- | N/A | We strongly advise our customers to use an Alpha Sender ID for submitting messages in Botswana | N/A |
...
- Botswana Phone Number: Yes
- Botswana Short Code: Yes
...
| Service restrictions | There's traffic differentiation based on origin and type. Sender registration is required for both local and international traffic origin. Before you start sending any content towards Botswana for the first time, contact your dedicated account manager or [Support](mailto:support@infobip.com). |
| Service provisioning | Service provisioning is up to 1 week. For networks where registration is required for international-origin traffic, service provisioning should be available within a day. |
| Sender availability | Alpha and numeric senders allowed. Generic senders might get blocked |
...
| Country regulations | Political, adult, gambling (sender names or content) is not allowed. |
| Country restrictions | Unless a consumer has implicitly requested or agreed otherwise, companies may not engage in any direct marketing towards a consumer on: - Sundays, public holidays contemplated in the Public Holidays Act; - Saturdays before 9 AM and after 1 PM; - All other days between the hours of 8 PM and 8 AM the following day. |
| Country recommendations | Before you start sending local-origin traffic to Botswana, register your senders avoid failing traffic. For additional info, reach out to [Support](mailto:support@infobip.com) or your dedicated account manager. |