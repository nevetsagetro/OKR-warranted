...
Source: https://www.twilio.com/en-us/guidelines/to/sms
...
| --- | --- | --- |
| Locale name | --- | Tonga |
| ISO code | The International Organization for Standardization two character representation for the given locale. | TO |
| Region | --- | Oceania |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 539 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +676 |
...
- Tonga Phone Number: Yes
- Tonga Short Code: Yes
...
| Service restrictions | Before you start sending messages towards Tonga, contact your dedicated account manager or [Support](mailto:support@infobip.com) because of specific regulations. |
