...
Source: https://www.twilio.com/en-us/guidelines/lt/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | LT |
| Region | --- | Europe |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 246 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +370 |
...
- Lithuania Phone Number: Yes
- Lithuania Short Code: Yes
...
| Two-way provisioning | It can take 2-3 days. |
| Country regulations | Opt-in list must be available on Operator's demand, opt-out option must be inserted in message text. Generic senders are not allowed. General anti spam rules apply. |
