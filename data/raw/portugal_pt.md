...
Source: https://www.twilio.com/en-us/guidelines/pt/sms
...
| ISO code | The International Organization for Standardization two character representation for the given locale. | PT |
| Region | --- | Europe |
| Mobile country code | A three digit code associated with the given locale and used in conjunction with a Mobile Network Code to uniquely identify mobile networks. | 268 |
| Dialing code | The dialing prefix used to establish a call or send an SMS from one locale to the given locale. | +351 |
...
- Portugal Phone Number: Yes
- Portugal Short Code: Yes
...
| Service restrictions | No specific restrictions for sending traffic towards Portugal. |
| Service provisioning | Sender provisioning should be available within a day, more if it's a specific setup. |
| Sender availability | Alphanumeric, Short Codes, Virtual Long Numbers, and Dynamic. Generic senders are allowed. |
